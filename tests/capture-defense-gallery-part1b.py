...
with sync_playwright() as p:
    ...
    capture(browser,'04-phone-tower-panel',(430,932),'moon', '''()=>{RizoRuntimeQA.defenseSetCashForQA(9999);for(let i=0;i<4;i++)RizoRuntimeQA.defensePlaceNextForQA();RizoRuntimeQA.defenseShowTowerPanelForQA();}''')
